...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScriptView_t, stringdata) + ofs \
...
const QMetaObject ScriptView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_ScriptView.data,
      qt_meta_data_ScriptView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
